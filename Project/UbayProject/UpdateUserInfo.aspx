                    ...
                    <table class="table table-dark table-hover" id="tableUserInfo">
                        <tbody>
                            <tr id="trUserName">
                                ...
                                <td>
                                    <asp:TextBox ID="txtUserName" runat="server" placeholder="暱稱" MaxLength="4000" Rows="5"></asp:TextBox></td>
                            </tr>
                            <tr id="trUserSex">
                                <td>性別</td>
                                <td >
                                    <asp:DropDownList ID="ddlUserSex" runat="server">
                                        ...
                                        <asp:ListItem Value="不公開">不公開</asp:ListItem>
                                    </asp:DropDownList>    
                                </td>
