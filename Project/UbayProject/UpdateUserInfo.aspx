        ...
        <div class="container" id="divUserInfo">
            ...
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-4 col-sm-12 align-self-start " id="divImg">
                    ...
                    <div>
                        <asp:TextBox ID="txtImg" runat="server" Text="" placeholder="data:image/......." TextMode="Url" MaxLength="500" Enabled="False"></asp:TextBox>
                    ...
                    <table class="table table-dark table-hover" id="tableUserInfo">
                        <tbody>
                            <tr id="trUserName">
                                ...
                                <td>
                                    <asp:TextBox ID="txtUserName" runat="server" placeholder="暱稱" MaxLength="20" Rows="5" Enabled="False"></asp:TextBox></td>
                            </tr>
                            <tr id="trUserSex">
                                <td>性別</td>
                                <td >
                                    <asp:DropDownList ID="ddlUserSex" runat="server">
                            ...
                            <tr id="trUserBirthday">
                                <td>生日</td>
                                <td>
                                    <asp:TextBox ID="txtUserBirthday" runat="server" Enabled="False"></asp:TextBox></td>
                            </tr>
                            <tr id="trUserIntro">
                                <td>自我介紹</td>
                                <td>
                                    <asp:TextBox ID="txtUserIntro" runat="server" MaxLength="4000" TextMode="MultiLine" style="width:80%" Enabled="False"></asp:TextBox>
                                </td>
                            </tr>
                        </tbody>
                    </table>
