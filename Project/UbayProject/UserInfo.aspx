                    ...
                    <table class="table table-dark table-hover" id="tableUserInfo">
                        <tbody>
                            <tr id="trUserName">
                                ...
                                <td>PCW</td>
                                <td>
                                    <asp:Button class="btn btn-outline-light" ID="btnUpdateUserName" runat="server" Text="修改" />
                                </td>
                            </tr>
                            <tr id="trUserSex">
                                <td>性別</td>
                            ...
                            <tr id="trUserBirthday">
                                <td>生日</td>
                                <td colspan="2">2021/08/20</td>
                            </tr>
                            <tr id="trUserIntro">
                                <td>自我介紹</td>
                                <td>大家好！我是 ◯◯◯ ，畢業於東方哈佛 XX 系，我爸爸和媽媽都是商業背景出身，我從小耳濡目染，具備了商業的敏銳度！我的個性活潑開朗、積極主動，喜歡與人接觸，畢業後，進入 XX 公司擔任業務助理，期間每天幫忙整理業務報表，之後又加入 XX 公司，擔任業務工作，服務過很多客戶，客戶都很喜歡我，對我讚譽有加。還有，我平常最喜歡慢跑、看電影，最喜歡的電影是《全面啟動》......</td>
                                <td>
                                    <asp:Button class="btn btn-outline-light" ID="btnUpdateUserIntro" runat="server" Text="修改" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
