...
namespace UbayProject
{
    public partial class UpdateUserInfo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var queryStringKeys = this.Request.QueryString.AllKeys;
            if (queryStringKeys.Contains("updateusername") )
            {
            ...
            else if (queryStringKeys.Contains("updateuserintro"))
            {
                this.txtImg.Enabled = false;
                this.txtUserBirthday.Enabled = false;
            ...
            else if (queryStringKeys.Contains("updateuserimgurl"))
            {
                this.txtImg.Enabled = false;
                this.txtUserBirthday.Enabled = false;
                this.txtUserIntro.Enabled = false;
            ...
            // 取得QueryString並填入使用者資訊(注意顯示時要注意輸出檢查)
